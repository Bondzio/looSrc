...
<br>
<!--<label><input type="range" value=75 min=0 max=100 data-scale=0.01 data-for="parser.renderingOptions.fracReducer"/>fracReducer = <span>12</span></label><br>
label><input type="range" value=50 min=0 max=200 data-scale=0.01 data-for="parser.renderingOptions.fracUp"/>fracUp = <span>12</span></label><br>
<label><input type="range" value=50 min=0 max=200 data-scale=0.01 data-for="parser.renderingOptions.fracDown"/>fracDown = <span>12</span></label><br
