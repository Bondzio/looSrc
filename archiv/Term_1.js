...
Term.prototype.getFinalResult = function(scope) {
  ...
  if(currentNodes.length) {
    ...
    var resultsign = result < 0? ("<span class='operator__sign minus' style='width:"+this.rOpt.signWidth+"em;'><svg height='1em' width='"+this.rOpt.signWidth+"em' viewBox='0 0 "+this.rOpt.signWidth+" 1' style='stroke:currentColor;stroke-width:"+this.rOpt.strokeThickness+"em'><line x1='0' y1='"+this.rOpt.signHeight+"' x2='"+this.rOpt.signWidth+"' y2='"+this.rOpt.signHeight+"'></line></svg></span>"):"";
