...
<script>
  ...
  document.getElementById("save").addEventListener("click", function() {
    ...
    var data = {code: localStorage.looopCode, task: "JSONinsert", path: "<?=$bookmarkspath?>", content: newBookmark, uniquetitle: true}
    $.post("../php/saveSafeCentral.php", data, responseAnalyzer).then(function(data) {
